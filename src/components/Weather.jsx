...
const Weather =({weather}) => {
  ...
  return (
    <div className=' text-white w-full font-light flex flex-col items-center justify-center py-4 px-2'>
      ...
      <div className='flex justify-center items-center flex-col mb-4 w-full rounded-md bg-black/70 lg:flex-row p-6 lg:w-3/4'>
        ...
        <h3 className='text-3xl my-2 lg:text-5xl'>{weather.location.name}</h3>
        <h1 className='text-6xl lg:text-8xl'>{weather.current.temp_c}&deg;C</h1>
        <h4 className='m-2 text-lg lg:text-2xl'>{weather.current.condition.text}</h4>
        </div>
        <div>
        <img className='h-auto w-20 lg:w-56' src={weather.current.condition.icon} alt="Weather Condition" />
        </div>
      </div>
        ...
        <div className='flex flex-col justify-center items-center rounded-md bg-black/70 px-4 py-10'>
          ...
          <p className='text-md'>{weather.current.humidity}%</p>
        </div>
        <div className='flex flex-col justify-center items-center rounded-md bg-black/70 px-4 py-10'>
          <BsWind size={30}/>
          <h5 className='m-2 font-bold lg:text-xl'>Wind</h5>
          <p className='text-md'>{weather.current.wind_kph} km/h</p>
        </div>
        <div className='flex flex-col justify-center items-center rounded-md bg-black/70 px-4 py-10'>
          <BsCloudsFill size={30}/>
          <h5 className='m-2 font-bold lg:text-xl'>Clouds</h5>
          <p className='text-md'>{weather.current.wind_kph}%</p>
        </div>
        <div className='flex flex-col justify-center items-center rounded-md bg-black/70 px-4 py-10'>
